...
if (!user) {
setAuthError('You must create an account before submitting predictions.');
setStep(0);
return;
}
...
return ( <main className="app"> <div className="glow glow-left" /> <div className="glow glow-right" />
...
```
  <section className="hero">
    <div className="hero-copy">
      ...
      <p>
        Players must complete all groups from A to L and all group-stage games.
        Knockout predictions stay closed until the knockout phase is ready.
      </p>

      <button className="primary" onClick={() => setStep(0)}>
        Create Account & Play <ChevronRight size={18} />
      </button>
    </div>
  ...
  <section className="rules">
    ...
    <article>
      ...
      <p>Predict the score and goal scorers for all {totalMatches} group-stage games.</p>
    </article>
  ...
  <section className="game-card">
    {step === 0 && (
      <div>
        ...
        {!loadingAuth && !user && (
          <>
            <p>
              Create an account to join the World Cup Predictor. Payment will be
              connected later with Stripe.
            </p>
        ...
        {!loadingAuth && user && (
          <>
            ...
            <button className="primary" onClick={() => setStep(1)}>
              Continue to Predictions <ChevronRight size={18} />
            </button>
    ...
    {step === 1 && (
      <div>
        ...
        <button className="primary" onClick={() => setStep(2)}>
          Predict Group {selectedGroup} <ChevronRight size={18} />
        </button>
      </div>
    )}
    ...
    {step === 2 && (
      <div>
        ...
        <div className="ranking-list">
          {current.ranking.map((team, index) => (
            <div className="ranking-row" key={team}>
              ...
              <div>
                <button onClick={() => moveTeam(selectedGroup, index, -1)}>
                  ↑
                </button>
                <button onClick={() => moveTeam(selectedGroup, index, 1)}>
                  ↓
        ...
        <button className="primary" onClick={() => setStep(3)}>
          Predict Scores <ChevronRight size={18} />
        </button>
      </div>
    )}
    ...
    {step === 3 && (
      <div>
        ...
        <div className="actions">
          <button onClick={() => setStep(1)}>Back to Groups</button>
    ...
    {step === 4 && (
      <div>
        ...
        <p>
          Completion: {completion}%. Players must complete all groups and all
    ...
    {step === 5 && submitted && (
      <div>
        ...
        <p>
          {username || user?.email || '@player'}, your prediction entry has been
          saved.
        </p>
