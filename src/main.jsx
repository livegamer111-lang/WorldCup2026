      ...
      <section id="play-section" className="game-card">
          ...
          <div className="auth-screen">
            <div className="auth-left">
              ...
              <ul className="feature-list">
                <li>
                  <Ticket /> {t.entryFee}: {money(ENTRY_FEE)}
                </li>
                <li>
                  <ShieldCheck /> {t.predictTableText}
                </li>
                <li>
                  <Goal /> {t.predictScoresText}
                </li>
                <li>
                  <TrendingUp /> {t.dailyLeaderboardText}
                </li>
                <li>
                  <Coins /> {t.prizeGrows}
                </li>
                ...
                <>
                  <div className="steps">
                    <div className="active">
                      1<span>{t.createYourAccount}</span>
                    </div>
                    <div>
                      2<span>{t.payEntry}</span>
                    </div>
                    <div>
                      3<span>{t.play}</span>
                    </div>
                  ...
                  <button className="auth-primary" onClick={handleEmailAuth}>
                    {authMode === 'signup' ? t.createYourAccount : t.login}
                  </button>
              ...
              {!loadingAuth && user && hasPaid && (
                <>
                  ...
                  <button className="auth-primary" onClick={() => setStep(1)}>
                    {t.startPredictor} <ChevronRight size={18} />
                  </button>
        ...
        {step === 1 && (
          <div>
            ...
            >
              {completion === 100 ? t.reviewSubmit : t.continueEntry}
        ...
        {step === 2 && (
          <div>
            ...
            {isGroupTableLocked() && <p className="error">{t.locked}</p>}
            ...
            <button className="primary" onClick={() => setStep(3)}>
              {t.scoresTitle} <ChevronRight size={18} />
            </button>
          </div>
        )}
        ...
        {step === 4 && (
          <div>
            ...
            <div className="review-grid">
              ...
              <div>
                <Lock />
                <b>{t.knockoutLocked}</b>
                <span>{t.knockoutText}</span>
              </div>

              <div>
                <Crown />
                <b>{t.dailyLeaderboard}</b>
                <span>{t.dailyLeaderboardText}</span>
              </div>
            </div>
        ...
        {step === 5 && submitted && (
          <div>
            ...
            <p>
              {username || user?.displayName || user?.email || '@player'}, {t.savedText}
            </p>
